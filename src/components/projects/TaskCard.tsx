    ...
    <Draggable draggableId={task.id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          className={cn(
            "group outline-none select-none active:scale-[0.98] transition-transform",
          ...
          <Link href={`/tasks/${task.id}`}>
            <GlassCard 
              ...
              className={cn(
                ...
                snapshot.isDragging ? "rotate-[2deg] scale-[1.02] shadow-2xl" : "hover:border-[var(--accent-cyan)]"
              )}
            >
              {/* Priority Indicator */}
              <div 
